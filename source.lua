...
if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Lyntrexificent is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "Loading Lyntrexificent..."
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "🎆Lyntrexificent v" .. currentVersion
...
About.TextSize = 14
About.Text = "Plugins are currently not available files."
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Lyntrexificent Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, Lyntrexificent may have issues or features that are not functioning correctly.") end
end)
